...
<body>
    ...
    <a href="Timelog.aspx">Timelog </a>
            ...
            <ContentTemplate>
                ...
                <p>
                    Sort:<asp:RadioButtonList ID="rblSortType" runat="server" AutoPostBack="True" onSelectedindexchanged="rblSortType_SelectedIndexChanged" RepeatDirection="Horizontal" RepeatLayout="Flow">
                        <asp:ListItem Selected="True" Value="0">Price</asp:ListItem>
                        <asp:ListItem Value="1">Sq. Feet</asp:ListItem>
                    </asp:RadioButtonList>
                </p>
                <p>
                    All Properties<br /> <span class="auto-style2">Price&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Sq.Feet&nbsp; Beds&nbsp; Baths&nbsp; Year Built&nbsp; $/Sq.Foot</span><br class="auto-style2" />
                    <asp:TextBox ID="txtProperties" runat="server" Height="232px" TextMode="MultiLine" Width="531px"></asp:TextBox>
                    <br />
                    <br />
                    <br />
                    </p>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionStringAccessDatabase %>" ProviderName="<%$ ConnectionStrings:ConnectionStringAccessDatabase.ProviderName %>" SelectCommand="SELECT * FROM [Properties]"></asp:SqlDataSource>
    </form>
</body>
</html>
